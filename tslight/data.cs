...
namespace tslight
{
	...
	public class DataTable_security : DataTable
	{
        ...
        public DataColumn security_board;
        public DataColumn security_point_cost;
		//--------------------------------------------------------------------------------
		...
		//--------------------------------------------------------------------------------
        public DataRow_security Add_Row(int security_id, string security_name, string security_code, string security_board, int lotsize, double security_point_cost )
		{
			DataRow_security row = (DataRow_security)NewRow();
			object[] aValues = new object[]
			{
				security_id, security_name, security_code, lotsize, security_board, security_point_cost
			};
		...
		internal void InitVars()
		{
            ...
            security_board = Columns["security_board"];
            security_point_cost = Columns["security_point_cost"];
		}
		//--------------------------------------------------------------------------------
		internal void InitClass()
		{
			...
			Columns.Add(lotsize);
            security_board = new DataColumn("security_board", typeof(string), null, MappingType.Element);
            Columns.Add(security_board);
            security_point_cost = new DataColumn("security_point_cost", typeof(string), null, MappingType.Element);
            Columns.Add(security_point_cost);
	...
	public partial class DataRow_security : global::System.Data.DataRow
	{
        ...
        public string security_board
        {
            get { return (string)this[table.security_board]; }
            set { this[table.security_board] = value; }
        }
        public double security_point_cost
        {
            get { return (double)this[table.security_point_cost]; }
            set { this[table.security_point_cost] = value; }
        }
